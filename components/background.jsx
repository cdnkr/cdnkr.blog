...
export default function Background() {
  ...
  return (
    <div
      // using inline styles as bg doesn't cover height of the screen when using tailwind 🤷‍♂️
      style={{
        position: "fixed",
        top: 0,
        left: 0,
    ...
    >
      ...
      />
      <div className="absolute w-full h-full top-0 left-0 right-0 bottom-0 bg-black/80" />
    </div>
  );
}
