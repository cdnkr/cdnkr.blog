...
export default function Header({ className }) {
  ...
  return (
    <div className={cn("w-full flex flex-col gap-4 relative border-b-2 border-dark pb-4", className)}>
      <div className="w-full flex gap-8 lg:gap-0 justify-between items-start mb-0 pb-2">
        <Link href="/">
