...
export function LinkedInOutline({
    className
}) {
    return (
        <svg className={cn("size-10 stroke-white fill-white", className)} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 50 50">
...
export function LinkedIn({
    ...
    return (
        <svg className={cn("size-10 fill-white", className)} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 50 50">
