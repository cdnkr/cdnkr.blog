...
I’m Chad—a front-end developer from South Africa. I love building, I love software engineering, I love design, I love the web. I'm passionate about pretty much everything JavaScript, design & front-end related.

![Me](/images/content/about/me/13.png)

I currently work at [forgood](https://www.forgood.co.za), an online volunteering platform that connects people to charities and causes. My day-to-day stack includes React, Next.js, TypeScript, TailwindCSS, VanillaJS, and Node.js.  
...
I hate sifting through unnecessary fluff when I just want **a clear, step-by-step guide** to the answer. No assumptions, no missing steps—just the solution, **plus a working demo** where possible. So, I decided to build a blog focused on exactly that:  
...
Here’s the Next.js config file in case you’re interested. It includes static export, MDX, and PWA setup:  
...
Technically, this blog didn’t *need* to be a PWA, but I have [a guide](/post/setting-up-a-pwa-in-nextjs) on setting one up and figured I’d demo the install button while I was at it.  
...
### Written in **JavaScript** (I mean ECMAScript - sorry Oracle)
...
I’m not a designer by trade—I didn’t use Figma, Photoshop, or Illustrator. I literally just tweaked Tailwind classes until I was happy. 🤷‍♂️  

That said, I *do* appreciate good design. I can spend hours scrolling through [Godly’s](https://godly.website/) insane collection of featured sites, just taking in all the creativity.  
...
### And that’s the story of this pretty average blog. 
