...
I work as a professional front-end developer at [forgood](https://www.forgood.co.za), mostly with Next.js, React, and occasionally Node.js. Over the years, I’ve built some pretty cool stuff, and I figured, why not share some of what I’ve learned? Yeah, yeah, there are a million blogs already doing this, but I didn’t really care if my articles or tutorials ever got seen. I just wanted to keep myself busy—playing [Call of Duty](https://en.wikipedia.org/wiki/Call_of_Duty) every evening wasn’t cutting it anymore.  
