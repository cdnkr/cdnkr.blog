...
That led me back to [Dribbble](https://dribbble.com/) and [CodePen](https://codepen.io/), where I found a few concepts I liked. Shoutout to [@dwinawan](https://dribbble.com/dwinawan) and [@jeremyckahn](https://codepen.io/jeremyckahn) - I really, really liked their [blog design](https://dribbble.com/shots/24983782-Design-Exploration-Blog-Website) and [pen](https://codepen.io/jeremyckahn/pen/XWbJZy). I drew a lot of inspiration from it. One evening later, I restyled the entire blog into *this* version.  

<ImageMasonry images={[
  { src: "/images/content/about/designrefdribbble.png", alt: "Design Ref Dribbble", caption: "dwinawan's design I liked from Dribbble." },
  { src: "/images/content/about/codependesignref.png", alt: "CodePen Design Ref", caption: "jeremyckahn's design I liked from CodePen." },
]} />
