...
I work as a professional frontend developer at [forgood](https://www.forgood.co.za), mostly with Next.js, React, and occasionally Node.js. Over the years, I’ve built some pretty cool stuff, and I figured, why not share some of it? Yeah, yeah, there are a million blogs already doing this, but I didn’t really care if my articles or tutorials ever got seen. I just wanted to keep myself busy—playing [Call of Duty](https://en.wikipedia.org/wiki/Call_of_Duty) every evening wasn’t cutting it anymore.  
...
So I stripped out all my custom [MDX](https://mdxjs.com/) elements and let Tailwind Typography work its magic. A few tweaks later… here we are.  
