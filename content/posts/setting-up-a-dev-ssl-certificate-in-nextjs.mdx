...
description: To test features that require HTTPS, such as device orientation and PWA's, you can set up a local SSL certificate using `mkcert` and then access your development site securely on both your PC and mobile device.
date: 2024-10-30
author: Chad Danker
