...
#### PLEASE NOTE:
This is not the recommended implementation, as it exposes environment keys client side. While this tutorial details how to restrict your API key to only your site, the Next.js implementation is favored as API keys are never exposed to the client. See [THIS EXAMPLE](/post/ai-chatbot-component-with-product-preview-cards-in-next-with-gemini-2-flash) for the full Next.js approach. 
