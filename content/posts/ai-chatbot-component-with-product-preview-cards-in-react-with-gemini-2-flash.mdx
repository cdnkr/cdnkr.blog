...
<Block
  className="not-prose mt-6 font-mono text-white"
  variant="dark"
...
>
  ...
  <p className="mt-1">
    ...
    See <a href="/post/ai-chatbot-component-with-product-preview-cards-in-next-with-gemini-2-flash" className="underline font-bold">this example</a> for the Next.js approach.
  </p>
</Block>
---
