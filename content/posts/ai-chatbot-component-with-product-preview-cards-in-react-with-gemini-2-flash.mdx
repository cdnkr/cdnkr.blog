...
>
  ...
  <p className="mt-1">
    This tutorial is a React only client side implementation. Your API key will be exposed client-side. Follow <a className="font-bold underline" href="#%20Project%20Setup%0D">the instructions</a> in <em>"Project set-up"</em> carefully to restrict your key to only be used by your site.
    </p>
