...
<Block
  className="not-prose mt-6 font-mono text-primary"
  variant="dark"
  caretPosition="top-left"
>
  <p className="uppercase font-bold">Please note!</p>
  <p className="mt-1">
    This tutorial is a React only client side implementation. Your API key will be exposed client-side. Follow <a className="font-bold underline" href="#%20Project%20Setup">the instructions</a> in <em>"Project set-up"</em> carefully to restrict your key to only be used by your site.
    </p>
